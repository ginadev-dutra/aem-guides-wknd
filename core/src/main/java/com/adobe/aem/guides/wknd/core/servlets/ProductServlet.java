...
import com.adobe.aem.guides.wknd.core.service.ProductServletService;
...
@ServiceDescription("Servlet Serve Product")
public class ProductServlet extends SlingAllMethodsServlet {
    private static final long serialVersionUID = 1L;

    @Reference
    private ProductServletService productServletService;
    ...
    protected void doPost(final SlingHttpServletRequest request, final SlingHttpServletResponse response) throws IOException, ServletException {
        productServletService.doPost(request, response);
    }

    @Override
    protected void doGet(final SlingHttpServletRequest request, final SlingHttpServletResponse response) throws ServletException, IOException {
        productServletService.doGet(request, response);
    }
    ...
    protected void doDelete(final SlingHttpServletRequest request, final SlingHttpServletResponse response) throws ServletException, IOException {
        productServletService.doDelete(request, response);
    ...
    protected void doPut(final SlingHttpServletRequest request, final SlingHttpServletResponse response) throws ServletException, IOException {
        productServletService.doPut(request, response);
